...
var Accordion = ({ sections, forceExpanded = false }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "rounded-xl overflow-hidden border border-gray-200 flex-1 flex flex-col min-h-0", children: sections.map((section) => {
...
function DragHere2({ size = "lg" }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-white/60 backdrop-blur-sm pointer-events-none grid place-items-center z-50", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center gap-3", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: `${cfg.text} font-medium text-gray-500`, children: isMobile ? "Toca para subir documentos" : "Arrastre aqu\xED" })
    ] }) })
  ] });
}
