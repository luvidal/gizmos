 ...
 * ]} />
 */
const Accordion = ({ sections, forceExpanded = false, defaultOpenId, bare = false }: AccordionProps) => {
    const initialOpenId = defaultOpenId === undefined ? sections[0]?.id ?? null : defaultOpenId
