                        ...
                        return (
                            <Fragment key={tab.id}>
                                ...
                                <button
                                    ...
                                    style={tabStyle}
                                    className={`${tabFlex} flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold py-3 sm:py-4 px-2 sm:px-4 md:px-5 truncate whitespace-nowrap overflow-hidden transition-all duration-200 ${rounded ? 'md:first:rounded-tl-btn md:last:rounded-tr-btn' : ''} ${isActive
                    ...
                    return (
                        <Fragment key={tab.id}>
                            ...
                            <button
                                onClick={(e) => { e.stopPropagation(); handleTabClick(tab.id) }}
                                style={tabStyle}
                                className={`${tabFlex} flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm md:text-base font-medium py-2.5 sm:py-3 px-2 sm:px-4 md:px-5 rounded-btn transition-all duration-200 ${isActive
